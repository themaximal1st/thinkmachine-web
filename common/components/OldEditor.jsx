        ...
        if (this.state.isImporting) {
            return (
                <div id="old-editor">
                    ...
                    <div id="old-editor-content">
                        <div id="old-editor-toolbar">
                            <button
                                onClick={() => this.setState({ isImporting: false })}
                                id="old-editor-cancel-icon">
                                {Icons.CloseIcon(5)}
                                Cancel
                            </button>
                            <button
                                onClick={this.handleImport.bind(this)}
                                id="old-editor-import-icon">
